...
print_r($_POST);
    ...
    if($type == "add"){
        ...
        $productID = $_POST['productID'];
        $statusDefaule = $_POST['statusDefaule'];
        
        if($statusDefaule == '1'){
            $sqlupdateStatus = "UPDATE product SET status = '0' WHERE productID = '$productID'";
        }else{
            $sqlupdateStatus = "UPDATE product SET status = '1' WHERE productID = '$productID'";
        }
